...
const UpdateDream = () => {
    ...
    const ApiRequest = values => {
        ...
        const sendRequest = async () => {
            setisLoading(true)
            try {
                const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/dreams/${dreamID}`, {
                    method: 'PATCH',
                    headers: {
                ...
                history.push("/" + auth.userId + "/dreams")
    ...
    const dreamID = useParams().dreamId
        ...
        <>
            ...
            <div className="dream-form">
                ...
                <form className="form-control" onSubmit={formik.handleSubmit}>
                    ...
                    <Button type="submit">Update Dream</Button>
                </form>
            </div>
        </>
    )
